# MA Plot Tab UI Builder
# Author: Eren Ada, PhD
# Date: 04/22/2026
#
# Returns the MA Plot Visualization tabPanel. Mirrors the Volcano tab
# structure so controls feel familiar; adds two MA-specific controls
# (x-axis transform and zero-log2FC reference line).

build_ma_tab <- function() {
  tabPanel(
    title = "MA Plot",
    value = "tab_ma",
    ...
    fluidRow(
      column(12,
        div(
          ...
          h2("MA Plot Visualization", style = "color: #2C3E50;"),
          p("Generate publication-ready MA plots with customizable parameters",
    ...
    fluidRow(
      ...
      column(4,
        wellPanel(
          ...
          div(
            ...
            p("Required: gene, baseMean, log2FoldChange, pvalue, padj, contrast",
          ...
          div(
            ...
            # X-axis transform (MA-specific)
            p(strong("X-axis Transform"), style = "color: #666; margin-top: 10px; margin-bottom: 5px;"),
            
            radioButtons(
              "ma_x_transform",
              label = NULL,
              choices = c(
                "log10(baseMean + 1)" = "log10",
                "log2(baseMean + 1)" = "log2"
              ),
              selected = "log10",
              inline = TRUE
            ),
            ...
            conditionalPanel(
              condition = "input.ma_draw_connectors == true",
              numericInput(
                "ma_connector_width",
                "Connector width:",
                value = 0.3,
            ...
            conditionalPanel(
              condition = "input.ma_show_subtitle",
            ...
            conditionalPanel(
              condition = "input.ma_show_caption",
            ...
            # Reference Lines
            p(strong("Reference Lines"), style = "color: #666; margin-top: 10px; margin-bottom: 5px;"),
            
            checkboxInput(
              "ma_show_zero_line",
              "Show zero log2FC reference line",
              value = TRUE
            ),
            
            checkboxInput(
              "ma_show_threshold_lines",
              "Show log2FC threshold lines",
              value = TRUE
            ),
            
            conditionalPanel(
              condition = "input.ma_show_threshold_lines == true",
              selectInput(
                "ma_threshold_style",
                "Line style:",
                choices = c(
            ...
            conditionalPanel(
              condition = "input.ma_fix_axes == true",
      ...
      column(8,
        conditionalPanel(
          condition = "output.ma_available",
          
          # Upload Status Indicator
          uiOutput("ma_data_source_info"),
          
          # Counts Summary
          wellPanel(
            style = "background-color: #f0f8ff; border-left: 4px solid #3498DB;",
            uiOutput("ma_counts_summary")
          ),
        ...
        conditionalPanel(
          ...
          wellPanel(
            ...
            p("Select a contrast from the dropdown or upload DEG results (including baseMean) to generate an MA plot.",
      ...
      fluidRow(
        column(12,
          wellPanel(
            ...
            DT::dataTableOutput("ma_gene_table")
          )
        )
      )
    )
